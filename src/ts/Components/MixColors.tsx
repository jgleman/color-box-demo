...
function MixColors() {
  ...
  return (
    <div className="mx-2 my-4 rounded-2xl border border-zinc-100 bg-white p-6 shadow-sm md:mx-auto md:w-11/12 md:max-w-3xl md:p-8 dark:border-zinc-700 dark:bg-zinc-800">
      <p className="mx-auto w-full text-zinc-700 dark:text-zinc-300">
        Adjust the mix slider to see a demonstration of the{" "}
        <a
          className="text-teal-600 underline underline-offset-2 hover:text-teal-800 dark:text-teal-400 dark:hover:text-teal-300"
      ...
      <p className="mx-auto mb-4  w-full text-sm text-zinc-500 dark:text-zinc-400">
      ...
      <div className="mb-6 flex flex-col items-center justify-between sm:flex-row">
        <div className="mb-2 flex w-52 flex-col items-center justify-between">
          <label htmlFor="color1" className="text-md uppercase text-zinc-700 dark:text-zinc-300">
            Color 1
          </label>
          <input
            id="color1"
        ...
        <div className="mb-2 flex w-52 flex-col items-center justify-between">
          <label
            htmlFor="weight"
            className="text-md w-full text-center uppercase text-zinc-700 dark:text-zinc-300"
          >
            Mix{" "}
        ...
        <div className="mb-2 flex w-52 flex-col items-center justify-between">
          <label htmlFor="color2" className="text-md uppercase text-zinc-700 dark:text-zinc-300">
            Color 2
          </label>
          <input
            id="color2"
